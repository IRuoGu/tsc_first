...
print("打开视频...")
cap = cv2.VideoCapture(r'D:\vehicle_data\CheDao\高速公路匝道\032701.mp4') #参数为0是打开摄像头，文件名是打开视频
...
while True:
    ...
    cv2.namedWindow("frame2", 0)  # 0可调大小，注意：窗口名必须imshow里面的一窗口名一致
    cv2.resizeWindow("frame2", 800, 450)  # 设置长和宽
